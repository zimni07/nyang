...
data = {
    '남자': {
        '100m 달리기(초)': [(0,13.0, float('inf'), 10), (13.1, 13.5, 9), (13.6, 14.0, 8), (14.1, 14.5, 7), (14.6, 15.0, 6), (15.1, 15.5, 5), (15.6, 16.5, 4), (16.6, 16.9, 3), (17.0, float('inf'), 1)],
    ...
    '여자': {
        '100m 달리기(초)': [(0,16.5, float('inf'), 10), (17.1, 17.0, 9), (17.6, 17.5, 8), (18.1, 18.0, 7), (18.6, 18.5, 6), (19.1, 19.0, 5), (19.6, 19.5, 4), (20.1, 20.0, 3), (21.1, float('inf'), 1)],
