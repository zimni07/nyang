...
data = {
    '남자': {
        '100m 달리기': [(0, 13.0, 10), (13.1, 13.5, 9), (13.6, 14.0, 8), (14.1, 14.5, 7), (14.6, 15.0, 6), (15.1, 15.5, 5), (15.6, 16.5, 4), (16.6, 16.9, 3), (17.0, float('inf'), 1)],
        '1,000m 달리기': [(0, 230, 10), (231, 237, 9), (238, 243, 8), (244, 249, 7), (250, 255, 6), (256, 261, 5), (262, 267, 4), (268, 273, 3), (274, 278, 2), (279, float('inf'), 1)],
        '윗몸일으키기': [(58, float('inf'), 10), (57, 57, 9), (54, 56, 8), (51, 53, 7), (45, 50, 6), (39, 44, 5), (35, 38, 4), (30, 34, 3), (24, 29, 2), (0, 23, 1)],
    ...
    '여자': {
        '100m 달리기': [(0, 16.5, 10), (17.1, 17.0, 9), (17.6, 17.5, 8), (18.1, 18.0, 7), (18.6, 18.5, 6), (19.1, 19.0, 5), (19.6, 19.5, 4), (20.1, 20.0, 3), (21.1, float('inf'), 1)],
